...
export function guideSteps(
  ...
  return {
    ...
    finish: {
      text: `That was one race. The winner takes the losing car as a pink slip: the car is theirs now. Collect ${t.pinkSlipsToWin} pink slips and you win the match. Press Continue for the next race.`,
      toward: 'none',
    },
  }
}
