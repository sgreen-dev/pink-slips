...
EFFECTS: dict[str, tuple[float, str]] = {
    ...
    "advance-sports": (1.5, "A Sports car's advance, in place of the general one"),
    "advance-luxury": (1.5, "A Luxury car's advance, in place of the general one"),
    "advance-muscle": (1.5, "A Muscle car's advance, in place of the general one"),
    "advance-jdm": (1.5, "A JDM car's advance, in place of the general one"),
    "advance-ev": (1.5, "An EV's advance, in place of the general one"),
    "advance-offroad": (1.5, "An Off-road car's advance, in place of the general one"),
