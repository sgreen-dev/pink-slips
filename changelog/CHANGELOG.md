...
- After a race, Continue opens the next race at the top of the page; the result screen opens at the top and returns there when the pack pop-up closes; the pop-up returns to its top with each pack opened. (the commit that added this line)
