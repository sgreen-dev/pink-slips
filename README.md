...
| `npm run sim`                              | play CPU against CPU and print the balance report |
| `npm run sim:types`                        | measure each car type closely against the field (about two minutes) |
