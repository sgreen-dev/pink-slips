...
With the CPU on both sides each garage wins about half its matches overall — 48, 49, 50 and 53 at 40,000 matches on seed 1 — and they beat each other in a cycle: Street Kings over The Long Game, The Long Game over Tuners, Tuners over Spoilers, Spoilers over Street Kings. Every link holds on seeds 1, 2 and 3, at 61/61/56, 56/55/55, 55/56/58 and 65/62/63, and the two pairings across the cycle are measured too and stay near even, so the cycle is a finding rather than an assumption.
