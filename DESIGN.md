...
Tuned in phase 50: Off-road's multiplier came down from 1.2 to 1.17, the smallest step that brought it inside the band on both seeds (1.15 read 50%, 1.12 read 47%, 1.1 read 44%). The field readings are Sports 55.1 / 55.9, Luxury 51.6 / 50.9, Muscle 50.9 / 51.4, JDM 49.3 / 49.1, EV 49.2 / 49.4, Off-road 52.2 / 52.7, and the intro set 43.9 / 45.7. Five types sit inside the band on both seeds. Sports sits just over it, and only under the Street CPU: Street reads every coin flip as tails except the one the Sports rule makes heads, so Nitrous Shot and Overdrive work for a Sports garage and for no other, and under Pro, which reads flips at their odds, Sports reads 47 to 48. Trimming its multiplier would make it the weakest type for anyone who plays those cards, so it stays at 1 and the cause is backlog G22.
